...
void glfmMain(GLFMDisplay *display) {
    ...
    utf8_append_c(bootclasspath, (char*)glfmGetResRoot());
    utf8_append_c(bootclasspath, "/resfiles/minijvm_rt.jar;");
    utf8_append_c(bootclasspath, (char*)glfmGetResRoot());
    utf8_append_c(bootclasspath, "/resfiles/minijvm_extras.jar;");
    utf8_append_c(bootclasspath, (char*)glfmGetResRoot());
    utf8_append_c(bootclasspath, "/resfiles/joml-1.9.25.jar;");
    
    Utf8String *classpath = utf8_create();
    utf8_append_c(classpath, (char*)glfmGetResRoot());
    utf8_append_c(classpath, "/resfiles/glfm_gui.jar;");
    utf8_append_c(classpath, (char*)glfmGetResRoot());
    utf8_append_c(classpath, "/resfiles/JadeFX.jar;");
    utf8_append_c(classpath, (char*)glfmGetResRoot());
    ...
    sys_properties_set_c(refers.jvm, "glfm.res.root", (char*)glfmGetResRoot());
    sys_properties_set_c(refers.jvm, "glfm.save.root", (char*)glfmGetSaveRoot());
    sys_properties_set_c(refers.jvm, "glfm.uuid", (char*)glfmGetUUID());
